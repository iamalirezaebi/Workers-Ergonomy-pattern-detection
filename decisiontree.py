...
def predict_image_risk( image_path):
    # Preprocess the image
    image_data, features = preprocess_images(image_path)

    # Use the trained model to predict the risk
    prediction = train_decision_tree_classification( features)

    return prediction



def train_decision_tree_classification(features, labels, max_depth=None,model_path = 'model.decisiontree'):
...
train_decision_tree_classification(features, labels)
